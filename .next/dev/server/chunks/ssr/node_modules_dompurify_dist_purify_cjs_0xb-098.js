...
/*! @license DOMPurify 3.4.15 | (c) Cure53 and other contributors | Released under the Apache license 2.0 and Mozilla Public License 2.0 | github.com/cure53/DOMPurify/blob/3.4.15/LICENSE */ function _arrayLikeToArray(r, a) {
    ...
    const _sanitizeAttributes = function _sanitizeAttributes(currentNode) {
       ...
       attribute allowlist off its shared binding before a hook can see it. */ ALLOWED_ATTR = _forkSharedAllowlist(hooks.uponSanitizeAttribute, ALLOWED_ATTR, DEFAULT_ALLOWED_ATTR, SET_CONFIG_ALLOWED_ATTR);
        ...
        /* Go backwards over all attributes; safely remove bad ones */ while(l--){
         ...
         neutralization pass (SO-001). */ let recreatedNamedProp = false;
       ...
       */ if (SANITIZE_NAMED_PROPS && (lcName === 'id' || lcName === 'name') && stringIndexOf(value, SANITIZE_NAMED_PROPS_PREFIX) !== 0) {
           ...
           record (SO-001). */ if (cleanWrite && recreatedNamedProp) {
     ...
     * from the captured bindings just above - so the two cannot diverge. */ if (hooks.uponSanitizeElement.length > 0 || hooks.uponSanitizeAttribute.length > 0) {
       ...
       keep using and whose return value they ignore — unsanitized. REPORT-2. */ const inPlace = IN_PLACE && typeof dirty !== 'string' && _isNode(dirty);
        if (inPlace) {
         ...
         appended element and its descendants. `body` covers all three. */ _sanitizeAttachedShadowRoots(body);
        } else {
