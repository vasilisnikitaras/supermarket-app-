...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$html5$2d$qrcode$2f$esm$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/html5-qrcode/esm/index.js [app-client] (ecmascript) <locals>"); // 📸 ΕΙΣΑΓΩΓΗ ΤΟΥ CAMERA SCANNER
...
function OrdersPage() {
    ...
    const [scannerActive, setScannerActive] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
        ...
        "OrdersPage.useEffect": ()=>{
            if (scannerActive && showModal) {
                ...
                scannerRef.current.render({
                    "OrdersPage.useEffect": (decodedText)=>{
                        // 🔎 Αναζήτηση προϊόντος αν ο EAN κωδικός περιέχεται μέσα στο όνομά του
                        const foundProd = products.find({
                            "OrdersPage.useEffect.foundProd": (p)=>p.name.includes(decodedText)
                        }["OrdersPage.useEffect.foundProd"]);
                        if (foundProd) {
                            setCurrentItem({
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                scannerActive && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    id: "reader",
...
_s(OrdersPage, "BpJ97q5fFMLtOYlidpW7gvN5oXw=");
_c = OrdersPage;
var _c;
